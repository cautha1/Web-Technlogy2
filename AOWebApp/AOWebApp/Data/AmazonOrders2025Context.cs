...
public partial class AmazonOrders2025Context : DbContext
{
    public AmazonOrders2025Context()
    {
    }

    public AmazonOrders2025Context(DbContextOptions<AmazonOrders2025Context> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=CauthanJB\\SQLEXPRESS;Initial Catalog=AmazonOrders2025;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
